...
namespace Modules.L2.Pawns
{
    ...
    public abstract partial class ActionDirectional<T> : ActionWithProperties<T> where T : ActionProperties
    {
        ...
        public override void UpdateMovement(double deltaTime, Pawn pawn)
        {
            ...
            CurrentMovementX = Distance.Calculate(CurrentSpeed * CurrentDirection.X, deltaTime);
            CurrentMovementY = Distance.Calculate(CurrentSpeed * CurrentDirection.Y, deltaTime);
        }
        ...
        {
            return CurrentSpeed * CurrentDirection.Vector;
        }
